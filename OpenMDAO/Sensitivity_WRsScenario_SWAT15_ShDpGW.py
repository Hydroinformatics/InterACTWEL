...
shp_dir = '/Users/sammy/Library/CloudStorage/Box-Box/Research/SWAT/SWAT_JetStream_runs/'
data_path = '/Users/sammy/Library/CloudStorage/Box-Box/Research/SWAT/SWAT_JetStream_runs/'
...
#     #             else:
#     #                 #atxt = atxt + str(999999).rjust(6) + ''.rjust(3)
#     #                 if int(linesplit[1]) == 1791 or int(linesplit[1]) == 1792 or int(linesplit[1]) == 1793:
#     #                     atxt = atxt + str(0).rjust(6) + ''.rjust(3)
#     #                 else:
#     #                     atxt = atxt + str(int(linesplit[3])).rjust(6) + ''.rjust(3)
#     #         else:

...
os.chdir(r'/Users/sammy/Documents/GitHub/InterACTWEL/OpenMDAO/')
...
swat_base_path = os.getcwd() + '/SWAT_WR_Files'
swat_test_path = os.getcwd() + '/SWAT_WR_Files/test_folder'
...
#Make sure to change this path to you own directory where the file is located.
hruwr_file_path = swat_base_path + '/hruwr_deepGW_CR.dat'
...
#Make sure to change this path to you own directory where the file is located.
wrdata_file_path = swat_base_path + '/wrdata_deepGW_CR.dat'
...
wrdata_df = pd.read_table(swat_base_path + '/wrdata_deepGW_CR.dat', sep='\s+', header=0)
...
prob.driver.options['pop_size'] = 2

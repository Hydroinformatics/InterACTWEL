...
!!    Water rights parameters  !!Added by Sammy    
      real, dimension (:), allocatable :: depthwr, hruwra
      integer, dimension (:), allocatable :: priorwr
      integer, dimension (:), allocatable :: hruwr, hruwrsrc
      integer, dimension (:), allocatable :: wrsrc, wrstrdate, wrendate
      integer :: mwr, mhruwr, kwr, wrdate

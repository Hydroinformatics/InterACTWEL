...
!!    arrays which contain data related to water rigths !! Added by Sammy
      allocate (depthwr(mwr))
      allocate (wrsrc(mwr))
      allocate (wrstrdate(mwr))
      allocate (wrendate(mwr))
      
      allocate (hruwra(mhruwr))
      allocate (hruwr(mhruwr))
      allocate (hruwrsrc(mhruwr))
      allocate (priorwr(mhruwr))

...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &    pestdb, fertdb, fcstfile, watrgt, hruwrf
...
!!Open database files
      ...
      read (101,5000) watrgt
      read (101,5000) hruwrf
      ...
      !! WRITE(*,*) watrgt
      !! WRITE(*,*) hruwrf
      open (207,file=watrgt)
      open (206,file=hruwrf)
...
!! septic result  J.Jeong Feb2009
	...
	write(173,5102) 'HRU','YEAR','DAY','Precip', 'PERC',        
     ...
     !! Total Water rights out
      open (9480,file='hru_wrt.out')

...
1005  format (a5,1x,a4,3i6,1x,e10.5,1x,2a15,7f10.2,20x,f10.2)
          ...
          case (10)   !! auto irrigation operation 
            !!WRITE(*,*) "auto irrigation operation ", j
            ...
            ! if (j == 632) then
            !   WRITE(*,*) "wstrs_id:  ", wstrs_id(j)
            !   WRITE(*,*) "auto_wstr: ", auto_wstr(j)
            !   WRITE(*,*) "irr_eff: ", irr_eff(j)
            !   WRITE(*,*) "irr_mx ", irr_mx(j)
            !   WRITE(*,*) "irr_asq: ", irr_asq(j)
            !   WRITE(*,*) "irr_sca: ", irr_sca(j)
            !   WRITE(*,*) "irr_noa: ", irr_noa(j)
            ! end if

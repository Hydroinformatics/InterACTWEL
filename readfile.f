...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &    pestdb, fertdb, fcstfile, watrgt, hruwrf, strwrf !! Added by Sammy
      ...
      tilldb = ""
      urbandb = ""
      watrgt = "" !! Added by Sammy
      hruwrf = "" !! Added by Sammy
      strwrf = "" !! Added by Sammy
...
!!Open database files
      ...
      read (101,5000) watrgt !! Added by Sammy
      read (101,5000) hruwrf !! Added by Sammy
      read (101,5000) strwrf !! Added by Sammy
      ...
      call caps(fertdb)
      call caps(urbandb)
      call caps(watrgt) !! Added by Sammy
      call caps(hruwrf) !! Added by Sammy
      call caps(strwrf) !! Added by Sammy
      ...
      open (207,file=watrgt) !! Added by Sammy
      open (206,file=hruwrf) !! Added by Sammy
      open (208,file=strwrf) !! Added by Sammy
...
!! septic result  J.Jeong Feb2009
	...
	write(173,5102) 'HRU','YEAR','DAY','Precip', 'PERC',        
     ...
     !! Total Water rights out ADDED by Sammy
      open (9480,file='wrs_use.out')
      write (9480,*) 'WRID   WATER(acre-ft)   YEAR'

      open (9481,file='hru_wrt.out')
      write (9481,*) 'HRU   WRID   WSRC   PRIOR   WATER(acre-ft)   YEAR'

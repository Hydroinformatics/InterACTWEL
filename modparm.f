...
!!    Water rights parameters  !!Added by Sammy    
      ...
      integer, dimension (:), allocatable :: hruwr, hruwrsrc
      integer, dimension (:,:), allocatable :: wrsrc, wrstdate
      integer, dimension (:,:), allocatable :: wrendate
      integer, dimension (:,:), allocatable :: hruwr_dict
      real*8, dimension (:), allocatable :: hruwruse_dict
      real*8, dimension (:,:), allocatable :: flowmin_wr
      !!integer, dimension (:), allocatable :: hru_dict, priorwr_dict
      integer :: mwr, mhruwr, uhruwr, kwr, wrdate, bool_priorwr
      integer :: wryr
...
!!    adding qtile to output.hru write 3/2/2010 gsm  increased heds(70) to heds(71)
      ...
      character(len=4) :: title(60), cpnm(9000) !(5000) Changed by Meghna Babbar-Sebens, 6/11/2020

...
if __name__ == '__main__':
    path = 'Z:/Projects/INFEWS/Modeling/TestProblem/Model/Scenarios/flow8gw/TablesOut//'
    ...
    SWAT_output_mdb_file = path + 'SWATOutput.mdb'
    ...
    for i in range(1, subbsnNum+1):
        path2 = 'Z:/Projects/INFEWS/Modeling/TestProblem/Model/Scenarios/flow8gw/TxtInOut/'
        csv_file = path2 + 'rch%s.csv' % str(i)

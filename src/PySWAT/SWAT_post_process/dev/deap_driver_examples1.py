...
#            raise RuntimeError(msg)
        ...
        self._ga = NSGAAlgorithm(self.objective_callback, self._cons, comm=comm)
...
class NSGAAlgorithm():
    ...
    def __init__(self, objfun, const, comm=None):
        """
...
#            if bits[varid] == 8 or bits[varid] < 0:
#                toolbox.register("attr_flt", random.uniform, vlb[varid], vub[varid])
#            else:
#                toolbox.register("attr_int", random.randint, vlb[varid], vub[varid])
        
        toolbox.register("attr_flt", random.uniform, 0, 10)
        #toolbox.register("individual", tools.initCycle, creator.Individual, (toolbox.attr_flt), n=1)
        toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_flt, 21)
